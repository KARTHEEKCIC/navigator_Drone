...
void check_receiver_inputs(byte movement){
  ...
  while(timer > millis() && trigger == 0){
    delay(250);
    if(receiver_input_channel_1 > 1603 || receiver_input_channel_1 < 1010){
      trigger = 1;
      receiver_check_byte |= 0b00000001;
      pulse_length = receiver_input_channel_1;
    }
    if(receiver_input_channel_2 > 1603 || receiver_input_channel_2 < 1010){
      trigger = 2;
      receiver_check_byte |= 0b00000010;
      pulse_length = receiver_input_channel_2;
    }
    if(receiver_input_channel_3 > 1603 || receiver_input_channel_3 < 1010){
      trigger = 3;
      receiver_check_byte |= 0b00000100;
      pulse_length = receiver_input_channel_3;
    }
    if(receiver_input_channel_4 > 1603 || receiver_input_channel_4 < 1010){
      trigger = 4;
  ...
  //Assign the stick to the function.
    ...
    if(movement == 1){
      ...
      if(pulse_length < 1010)channel_3_assign += 0b10000000;
    }
    if(movement == 2){
      channel_1_assign = trigger;
      if(pulse_length < 1010)channel_1_assign += 0b10000000;
    }
    if(movement == 3){
      channel_2_assign = trigger;
      if(pulse_length < 1010)channel_2_assign += 0b10000000;
    }
    if(movement == 4){
      channel_4_assign = trigger;
      if(pulse_length < 1010)channel_4_assign += 0b10000000;
    }
  }
}
